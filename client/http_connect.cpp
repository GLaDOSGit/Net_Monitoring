 ...
 *
 * This file_ptr is for http post info client.
*******************************************/
...
void HttpConnect::Post(string host, string url, string data, int port) {
...
int main () {
  ...
  h1->Post("10.3.5.57", "/test/search-post", "32=1654156&in=16345", 8000);
}
